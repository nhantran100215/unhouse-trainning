          ...
          <div className="flex flex-col z-10 tabWF:items-center">
            ...
            <div className="text-white/80">
              ...
              <div className="flex tabWF:justify-center">
                <div className="w-11 h-11 bg-white/20 rounded-xl m-3 flex justify-center items-center hover:bg-white hover:text-black duration-500 ease-linear ">
        ...
        <div className="form tabWF:form-tabWF ">
          ...
          >
            ...
            <div className="py-2">
              ...
              <span className="text-base text-grey-500 leading-7">
            ...
            <div>
              ...
              <label className="font-bold text-grey-500">
                Email
                <input
                  type="email"
                  name="email"
              ...
              <input
                ...
                className=""
              ></input>
              <label for="remember" className="m-3 text-grey-500 ">
                Remember my preference
              </label>
              {/* Signin */}

              <button className="w-full bg-blue-600 hover:bg-blue-660 transition-colors p-2 rounded-xl text-white my-3">
                Sign in
              </button>
              {/* SignUp */}

              <div className="font-normal text-base my-3">
                <span className="inline text-grey-500">

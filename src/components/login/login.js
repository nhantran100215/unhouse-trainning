...
const LoginPage = () => {
  ...
  return (
    <div className="bg-[url('../components/image/login-bg.jpg')] bg-cover bg-center font-sans flex justify-center items-center min-h-screen relative">
      <div className=" m-0 p-0 h-auto min-h-[600px] z-10 flex flex-col z-10 sm:m-12   sm:flex-col md:m-12   md:flex-row lg:m-24 lg:h-[calc(100vh-200px)]  after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-black/20 after:-z-10">
        {/* introduce */}

        <div className="p-12 w-full flex flex-col justify-center items-center bg-loginIntroduce text-center rounded-t-xl rounded-l-none overflow-hidden relative sm:rounded-l-none sm:rounded-t-xl md:w-3/5 md:rounded-t-none md:rounded-l-xl  md:text-left md:justify-between md:items-start ">
          {/* logo */}
          ...
          {/* welcom */}
          <div className="flex flex-col z-10 md:items-center lg:items-start">
            <h2 className="text-white text-4xl font-poppins_bold my-3">
              Welcome To Griya
            </h2>
            <div className="text-white/80">
              ...
              <div className="flex sm:justify-center md:justify-start">
                <div className="w-11 h-11 cursor-pointer bg-white/20 rounded-xl m-3 flex justify-center items-center hover:bg-white hover:text-black duration-500 ease-linear ">
              ...
              <div>
                <p className="inline text-sm font-poppins_regular">
                ...
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="mx-1 text-sm font-poppins_regular"
                >
                  DexignZone 2021
                </a>
              </div>
              <p className="text-sm font-poppins_regular">
                program by Nhan 2021
              </p>
            </div>
          </div>
          {/* decoration */}
          ...
          <div
            ...
            w-[150px] h-[150px] bg-blue-700/70 rounded-xl shadow-decorationblock"
          ></div>
          {/* up */}
          <div
            className=" absolute left-[-35px] top-[30%] rotate-45 z-0 animate-balloons1
            w-[150px] h-[150px] bg-white/30 rounded-xl shadow-decorationblock"
          ></div>
        </div>

        {/* form */}

        <div className="w-full p-12 bg-white flex flex-col justify-center rounded-r-none rounded-b-xl md:w-2/5  md:rounded-b-none md:rounded-r-xl ">
          <form
            name="loginform"
            onSubmit={onFinish}
          ...
          >
            ...
            <div className="py-2">
              <h3 className="text-black text-3xl font-poppins_bold my-3">
                Sign in
              </h3>
              <span className="text-base text-gray-500 leading-7 text-base font-poppins_regular">
            ...
            <div>
              ...
              <label className="font-bold text-gray-500">
                ...
                <input
                  ...
                  required
                  placeholder="email"
                  className="w-full focus:outline-none py-3 text-black border-b-2 mb-3"
                />
              </label>
              {/* Password */}
              <label className="font-bold text-gray-500">
              ...
              <label
                htmlFor="remember"
                className="m-3 text-gray-500 cursor-pointer"
              >
                Remember my preference
              </label>
              {/* Signin */}

              <button className="w-full bg-blue-600 hover:bg-blue-700 transition-colors p-2 rounded-xl text-white my-3">
                Sign in
              </button>
              {/* SignUp */}

              <div className="font-normal text-base my-3">
                <span className="inline text-gray-500 text-base font-poppins_regular">
                  Don't have an account?
                </span>
                <a
                  href="https://griya.dexignzone.com/react/demo/page-register"
                  className="text-blue-600 text-base font-poppins_regular"
                >
                  Sign up
                </a>
              </div>
